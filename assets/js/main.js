...
document.querySelector('.contact-form').addEventListener('submit', function(event) {
    ...
    Email.send(datosCorreo)
        .then(function (){

            alert('Su formulario ha sido enviado correctamente. Nos pondremos en contacto muy pronto.');
